            ...
            <div class="col-md-4">
                <div class="navbar-header page-scroll" style="margin-top: 8px">
                    <button class="btn btn-success"
                            onclick="location.href='${pageContext.request.contextPath}/admin/boardsadd'">
                        Back</button>
                </div>
            </div>
...
<section class="content">
    <div class="container" align="center">
        <h1 align="center" style="color: #4bb227">${errorMessage}</h1>
        <div style="margin-bottom: 20px"><img src="${pageContext.request.contextPath}/resources/img/DoesNot.jpg"></div>
        <h2 align="center" style="color: #4bb227">Set correct departing time</h2>
    </div>
</section>
