...
<section class="content">
    <div class="container" align="center">
        <h1 align="center" style="color: #49a827">${errorMessage}</h1>
        <div style="margin-bottom: 20px"><img src="${pageContext.request.contextPath}/resources/img/NoPlaces.jpg"></div>
        <h2 align="center" style="color: #49a827">Please, <a href="${pageContext.request.contextPath}/search">choose</a> another board</h2>
    </div>
</section>
