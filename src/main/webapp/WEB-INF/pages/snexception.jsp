...
<body>
<br>
<p style="font-size: 35px" align="center">Station with name '${existingStation}' already exists!</p>
...
<div class="container" align="center">
    ...
    <div class="row">
        <br>
        <p style="font-size: 30px" align="center">Please, choose another name</p>
