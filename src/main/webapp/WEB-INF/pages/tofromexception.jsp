...
<body>
<br>
<p style="font-size: 35px" align="center">Arrival station must differ from the departure one!</p>
...
<div class="container" align="center">
    ...
    <div class="row">
        <br>
        <p style="font-size: 30px" align="center">Please, choose other destination</p>
